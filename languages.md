...
#### moving forth (writing forth interpreters for various machines)
...
#### CONS Should Not CONS Its Arguments, Part II: Cheney on the M.T.A. (aka proper tail calls in generated C code)
